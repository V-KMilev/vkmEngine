...
public:
    ...
    GLInstanceBuffer(const GLInstanceBuffer&) = delete;
    GLInstanceBuffer& operator=(const GLInstanceBuffer&) = delete;
    GLInstanceBuffer(GLInstanceBuffer&&) = delete;
    GLInstanceBuffer& operator=(GLInstanceBuffer&&) = delete;
     ...
     *
     * @param matrices Pointer to array of model matrices
     * @param count Number of matrices
     */
    void update(const glm::mat4* matrices, uint32_t count);
