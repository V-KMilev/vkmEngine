 ...
 *
 * Each backend registers a builder per pass class name; the application
 * then walks a list of names and asks the factory to construct each pass.
...
class RenderPassFactory {
    ...
    public:
        ...
        /// Register a builder for @p name. Replaces an existing entry
