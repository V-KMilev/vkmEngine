 ...
 * loading stub, and reads/deserializes the binary off-thread on the ThreadPool;
 * finalisation happens on the main thread via AsyncLoaderSystem, exactly like
 * the editor's stb/Assimp loaders. No recipe factory, no Assimp, no stb.
 *
