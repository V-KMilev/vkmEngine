...
// Navigation-gizmo ball (drawlist): backing disc + rim ring.
inline constexpr ImU32 NAV_DISC_U32 = IM_COL32(20, 20, 22, 160);
inline constexpr ImU32 NAV_RING_U32 = IM_COL32(50, 50, 55, 200);

// Timeline (Bottom panel) drawlist palette - recessed track surface below
// the panel bg, quiet ruler/lane strokes.
...
// Font-relative so the column scales with the loaded font size / DPI
// (~100 px at the default 15 px font).
