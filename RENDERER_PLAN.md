...
| 18 | LTC area light specular (Phase 2C)       | 4     | Deferred until Heitz reference LUT data is sourced (mat + amp tables, ~32 KB). Current Karis representative-point with broadened GGX alpha is energy-conserving and gives the correct "highlight stretches across the source" without a LUT; the LTC win is mainly precision at grazing angles + high roughness | -                       |
